...
export default function HomePage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'InsuranceAgency', name: 'ALKEME Insurance Services', url: 'https://alkemeins.com', telephone: '+18559255363', email: 'info@alkemeins.com', description: 'ALKEME Insurance Services provides tailored commercial insurance solutions for businesses of all sizes across all 50 states.', foundingDate: '2003', numberOfEmployees: { '@type': 'QuantitativeValue', value: 100 }, knowsAbout: ['Commercial Insurance', 'General Liability', 'Workers Compensation', 'Cyber Liability'], hasCredential: { '@type': 'EducationalOccupationalCredential', credentialCategory: 'Professional License', name: 'Licensed Insurance Brokerage' }, areaServed: { '@type': 'Country', name: 'United States' }, parentOrganization: { '@type': 'Organization', name: 'ALKEME Insurance Services', url: 'https://alkemeins.com' }, serviceType: ['Commercial Business Insurance', 'General Liability', 'Workers Compensation', 'Commercial Property', 'Business Interruption', 'Professional Liability', 'Commercial Auto', 'Cyber Liability', 'Directors and Officers'], citation: { '@type': 'CreativeWork', name: 'Insurance Information Institute', url: 'https://www.iii.org' }, about: { '@type': 'Thing', name: 'Commercial Business Insurance' } }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Article', headline: 'Commercial Business Insurance Solutions', datePublished: '2025-06-01', dateModified: '2026-04-01', author: { '@type': 'Organization', name: 'ALKEME Insurance Services', url: 'https://alkemeins.com' }, publisher: { '@type': 'Organization', name: 'ALKEME Insurance Services', url: 'https://alkemeins.com', logo: { '@type': 'ImageObject', url: 'https://alkemeins.com/logo.png' } }, description: 'Comprehensive guide to commercial business insurance solutions for businesses of all sizes across all 50 states.', mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://alkemeins.com/business-insurance/' } }) }} />

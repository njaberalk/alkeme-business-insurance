        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-2">
              {['general-liability', 'workers-compensation', 'commercial-property', 'business-interruption', 'professional-liability'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {['startups-emerging', 'construction', 'automotive', 'hospitality', 'real-estate'].map(slug => (

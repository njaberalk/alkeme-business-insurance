...
export const metadata = {
  ...
  title: { template: '%s | ALKEME', default: 'Business Insurance | ALKEME' },
  ...
  twitter: { card: 'summary_large_image', title: 'Business Insurance | ALKEME', description: 'Tailored commercial insurance for businesses of all sizes across all 50 states.', images: ['https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&h=630&q=80'] },
